...
from gemini_prompt import generate_title, generate_description
...
def generate_description():
    try:
        ...
        prompt = (
            ...
            f"Description would be well written in good manner, add details write perfectly and must end with full stop sign. Do not wrap description into double quotation. Avoid using double quotation mark. "
        ...
        generated_description = re.sub(r"```|```json", "", generated_description).strip()
